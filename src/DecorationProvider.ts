...
export class DecorationProvider {
    private syncedDecorationType: vscode.TextEditorDecorationType;
    private driftedDecorationType: vscode.TextEditorDecorationType;
    ...
    public updateDecorations(editor: vscode.TextEditor) {
        ...
        vscode.commands.executeCommand<vscode.DocumentSymbol[]>('vscode.executeDocumentSymbolProvider', document.uri)
            .then(symbols => {
                ...
                const syncedRanges: vscode.DecorationOptions[] = [];
